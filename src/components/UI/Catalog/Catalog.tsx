...
import { fetchFilters, fetchProductsAsync, productSelectors } from "../../../store/shopping-cart/productSlice";
...
const  Catalog = () => {
  ...
  const {productsLoaded,filtersLoaded,status,brands,types} = useAppSelector(state => state.product)
